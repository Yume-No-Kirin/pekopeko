...
## Corpus Check
- 143 files · ~105,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1583 nodes · 2461 edges · 126 communities (98 shown, 28 thin omitted)
...
Cohesion: 0.14
Nodes (15): Knowledge Invariants Document, INV-002 AI Inference Is Not Sourced Fact, INV-005 Rejected ≠ False ≠ Unknown, INV-006 Contradictions Are Not Automatically Resolved, INV-007 Temporal Validity, INV-011 Representations Are Not Canonical Truth, INV-013 Derived Knowledge Can Become Stale, INV-014 Uncertainty Remains Explicit (+7 more)
...
Cohesion: 0.10
Nodes (61): INV-008 Domain Isolation, INV-009 Explicit Cross-Domain Operations, Context / Universe, Cross-Domain Task / Operation, Relationship, MOD-002 Modules Cannot Silently Cross Domain Boundaries, MOD-009 Cross-Domain Operations Must Be Explicit, English Learning (+53 more)
...
Cohesion: 0.15
Nodes (16): INV-010 Modules Do Not Own the Core Knowledge Model, Shared Knowledge Core, MOD-003 Modules Do Not Own the Shared Knowledge Model, MOD-008 Module-Specific Logic Must Remain Within the Module Boundary, What is a Module?, Module Capability Contract, Module Data Ownership, Module Lifecycle (+8 more)
...
Cohesion: 0.11
Nodes (38): ExtractionError, InvalidDomainError, Exception, Typed exceptions for the entity/event/relationship extraction pipeline., Raised when domain is not one of the allowed domains., Base class for all extraction/ module errors., Any, YAML frontmatter serialization for the extraction pipeline. Write-side only:… (+30 more)
...
Cohesion: 0.12
Nodes (24): extract_source(), ExtractionPipelineResult, Path, Provider, Named distinctly from providers.base.ExtractionResult (the raw…, Path, Shared test-only helpers for extraction/ tests. Not a fixture factory that…, Parse a '---\\n<yaml>---\\n\\n<body>' file independently of app code. (+16 more)
...
### Community 79 - "Knowledge Model Document"
Cohesion: 0.31
Nodes (14): INV-016 Source Content and Interpretation Remain Distinguishable, Assertion, Canonical Conceptual Flow, Canonical Knowledge, Derived Knowledge, Knowledge Model Document, Entity, Event (+6 more)
...
### Community 88 - "Current Non-Goals"
Cohesion: 0.18
Nodes (12): INV-001 Universal Human Validation, MOD-001 Modules Cannot Bypass Human Validation, CAP-001 Persistent Knowledge Management, Current Non-Goals, Explicitly Rejected Directions, Future Non-Goals, Human Control, Reliability (+4 more)
...
### Community 99 - "Candidate Capabilities"
Cohesion: 0.20
...
### Community 107 - "Product Definition"
Cohesion: 0.22
Nodes (9): INV-012 Derived Knowledge Is Traceable, MOD-010 Module Results Must Remain Traceable, Memory, Domain Separation, Primary User Goals, Problem Statement, Product Definition, Target User (+1 more)
...
### Community 113 - "INV-003 Provenance"
Cohesion: 0.29
Nodes (7): INV-003 Provenance, INV-004 History Is Never Silently Destroyed, INV-018 Important Mutations Are Auditable, Lifecycle Status, Provenance, MOD-004 Modules Must Preserve Provenance, Knowledge Integrity
...
### Community 121 - "Module Independence"
Cohesion: 0.40
Nodes (5): INV-017 Modules Remain Decoupled, Cross-Domain Operations, MOD-006 Modules Must Not Depend on Another Module's Internal Implementation, MOD-007 Module Removal Must Not Corrupt Unrelated Knowledge, Module Independence
