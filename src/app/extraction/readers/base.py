"""
Base interfaces for source readers used in extraction.

Independent of app/ingestion/readers/ - reimplemented rather than imported,
per this ticket's independence requirement.
"""
