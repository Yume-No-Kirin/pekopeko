"""
Task state management for the extraction pipeline.

Persisted outside the vault, locally, per-device (ADI-005) - loss of this
state is safe: it never affects canonical/proposal data, the caller simply
...
class TaskState:
    """Represents the state of an extraction task."""
